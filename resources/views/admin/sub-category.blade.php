    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Sub-Categories Management</h1>
                    <p class="text-gray-600">Manage product sub-categories for your system</p>
                </div>
        ...
        <div class="mb-8">
            <div class="relative max-w-md">
                ...
                <input wire:model.live="search" type="text" placeholder="Search sub-categories or categories..." 
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <button wire:click="openEditModal({{ $subCategory->id }})"
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12">
                                    <div class="text-center">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900 mb-2">No sub-categories found</h3>
                                        <p class="text-gray-600 mb-4">Get started by adding your first sub-category.</p>
                ...
                <form wire:submit="saveSubCategory" class="space-y-4">
                    ...
                    <div class="flex justify-end gap-3 mt-6">
                        ...
                        <button type="submit" wire:loading.attr="disabled" wire:loading.class="opacity-50 cursor-not-allowed" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors duration-200">
                            ...
                            {{ $subCategoryId ? 'Update' : 'Create' }} Sub-Category
                        </button>
                    </div>
                </form>
            </div>
    ...
    @if($showDeleteModal)
        <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
            <div class="relative bg-white rounded-lg shadow-xl max-w-md mx-auto p-6">
                ...
                <div class="text-center">
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">Delete Sub-Category</h3>
                    ...
                    <div class="flex justify-center gap-4">
                        ...
                        <button wire:click="deleteSubCategory" class="inline-flex items-center px-4 py-2 bg-red-600 text-white font-medium rounded-lg hover:bg-red-700 transition-colors duration-200">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
