    ...
    <div class="min-h-screen flex" x-data="{ sidebarOpen: false }">
        ...
        <aside class="fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0" 
            ...
            <div class="mb-4 px-4 pt-4 flex items-center justify-between">
                <img class="h-20 w-auto" src="{{ asset('makemypayment-logo.svg') }}" alt="Logo">
            ...
            <div class="py-6 px-4 overflow-y-auto pb-20">                
                <!-- Navigation -->
                <nav class="space-y-2">
                    <a href="{{ route('merchant.dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium text-gray-900 {{ $active == 'dashboard' ? 'bg-gray-100' : 'hover:bg-gray-100' }}">
                        <!-- Home SVG icon -->
                    ...
                    <a href="{{ route('admin.pending-kyc') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium text-gray-900 {{ $active == 'pending-kyc' ? 'bg-gray-100' : 'hover:bg-gray-100' }}">
                    ...
                    <a href="{{ route('admin.ip-and-callback-requests') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium text-gray-900 {{ $active == 'ip-and-callback-requests' ? 'bg-gray-100' : 'hover:bg-gray-100' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="{{ route('admin.merchants') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium text-gray-900 {{ $active == 'merchants' ? 'bg-gray-100' : 'hover:bg-gray-100' }}">
                    ...
                    @can('read-payouts')
                    <div class="mt-6 mb-2 text-xs text-gray-400 font-semibold px-3">Payouts</div>
                    <a href="{{ route('admin.payouts') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium text-gray-900 {{ $active == 'payouts' ? 'bg-gray-100' : 'hover:bg-gray-100' }}">
                        <!-- Updated Merchant SVG icon -->
                    ...
                    <a href="{{ route('admin.reports') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium text-gray-900  {{ $active == 'reports' ? 'bg-gray-100' : 'hover:bg-gray-100' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.categories') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium text-gray-900  {{ $active == 'categories' ? 'bg-gray-100' : 'hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.sub-categories') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium text-gray-900  {{ $active == 'sub-categories' ? 'bg-gray-100' : 'hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                @endcanany
                @can('read-roles')
                <a href="{{ route('admin.roles') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium text-gray-900 w-full mb-2 {{ $active == 'roles' ? 'bg-gray-100' : 'hover:bg-gray-100' }}">
                ...
                @can('read-staff')
                <a href="{{ route('admin.staffs') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium text-gray-900 w-full mb-2 {{ $active == 'staffs' ? 'bg-gray-100' : 'hover:bg-gray-100' }}">
                    <svg class="w-5 h-5 text-gray-900" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                @can('read-settings')
                <!-- Setting Button -->
                <a href="{{ route('admin.settings') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium text-gray-900 hover:bg-gray-100 w-full mb-2 {{ $active == 'settings' ? 'bg-gray-100' : 'hover:bg-gray-100' }}">
                    <svg class="w-5 h-5 text-gray-900" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <form method="POST" action="{{ url('logout') }}" class="mt-0">
                    @csrf
                    <button type="submit" class="flex items-center gap-3 px-3 py-2 rounded-lg font-medium text-gray-900 hover:bg-gray-100 w-full">
                        <svg class="w-5 h-5 text-gray-900" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7"></path></svg>
                        Logout
                    </button>
                </form>
            </div>
