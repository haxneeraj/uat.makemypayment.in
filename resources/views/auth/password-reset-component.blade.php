    ...
    <div class="w-full max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative z-10">
        ...
        <div class="hidden lg:flex flex-col justify-between h-full py-12">
            <div>
                <div class="mb-8">
                    ...
                    <h1 class="text-5xl font-black text-slate-900 leading-tight mb-4">
                        Set New Credentials.
                        <span
                            class="bg-gradient-to-r from-[#2b3990] via-[#4f63cb] to-[#6c3ec5] bg-clip-text text-transparent">Get Back Fast.</span>
                    </h1>
                    <p class="text-lg text-slate-600 leading-relaxed max-w-md">
                        Create a fresh password to secure your account and continue payout operations safely.
                    </p>
                </div>
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-slate-900">Protected Reset Flow</h3>
                            <p class="text-sm text-slate-600 mt-1">Token-based verification protects account access
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-slate-900">Fast Recovery</h3>
                            <p class="text-sm text-slate-600 mt-1">Reset once and resume dashboard access instantly
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="text-sm font-bold text-slate-900">24/7 Availability</h3>
                            <p class="text-sm text-slate-600 mt-1">Complete password updates anytime, anywhere
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="space-y-2 text-xs text-slate-500 mt-8">
                <p>✓ Reset links expire automatically for safety</p>
                <p>✓ Built for secure merchant operations</p>
                <p>✓ Trusted by 1000+ growing businesses</p>
            </div>
        </div>

        <!-- Right: Reset Password Card Section -->
                ...
                <div class="rounded-3xl border border-white/60 bg-white/95 shadow-[0_20px_60px_rgba(43,57,144,0.15)] backdrop-blur-xl p-8"
                    ...
                    <div>
                        <div
                            ...
                            <span
                                class="text-[11px] font-semibold uppercase tracking-[0.16em] bg-gradient-to-r from-[#2b3990] to-emerald-600 bg-clip-text text-transparent">Password
                                Reset</span>
                        </div>
                        <h2 class="text-3xl font-black text-slate-900 mb-2">Reset Your Password</h2>
                        <p class="text-slate-600 mb-8">Set a new password below to regain account access.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.update') }}" class="space-y-5" autocomplete="off"
                        ...
                        <div>
                            ...
                            <input id="email" name="email" type="email" required
                                ...
                                class="w-full px-4 py-3.5 rounded-2xl border border-slate-200 bg-slate-100/80 focus:ring-2 focus:ring-[#4f63cb] focus:border-transparent transition-all text-base text-slate-700 shadow-sm">
                        </div>

                        <div>
                            <label for="password"
                                class="block text-xs font-bold uppercase tracking-[0.12em] text-slate-700 mb-2.5">New
                                Password</label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="password_confirmation"
                                class="block text-xs font-bold uppercase tracking-[0.12em] text-slate-700 mb-2.5">Confirm
                                Password</label>
                            <div class="relative">
